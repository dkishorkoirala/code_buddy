...
if test_case == "transaction_class":
    ...
    success, message = bank.create_account(
        "savings", "S123", "John Doe", 1000, interest_rate=0.03
    )
    print(f"Success: {success}")
    print(f"Message: {message}")
    ...
    success, message = bank.create_account(
        "checking", "C456", "Jane Smith", 500, overdraft_limit=300
    )
    print(f"Success: {success}")
    print(f"Message: {message}")
    ...
    # Create accounts
    bank.create_account(
        "savings", "S123", "John Doe", 1000, interest_rate=0.05, min_balance=200
    )
    ...
    if "SavingsAccount" in locals():
        ...
        print("SavingsAccount methods work correctly")
    if "CheckingAccount" in locals():
        obj = CheckingAccount("test", "Test User")
        print("CheckingAccount methods work correctly")
    ...
    if "Transaction" in locals():
        ...
        print("Transaction attributes accessible")
    if "SavingsAccount" in locals():
        obj = SavingsAccount("test", "Test User")
        print("SavingsAccount attributes accessible")
    if "CheckingAccount" in locals():
        obj = CheckingAccount("test", "Test User")
        print("CheckingAccount attributes accessible")
    if "Bank" in locals():
        obj = Bank("test")
        print("Bank attributes accessible")
    ...
    try:
        obj = SavingsAccount("test", "Test User")
        success_count += 1
        print("SavingsAccount: Created successfully")
    except Exception as e:
        print(f"   SavingsAccount: Creation failed - {e}")
    try:
        obj = CheckingAccount("test", "Test User")
        success_count += 1
        print("CheckingAccount: Created successfully")
    except Exception as e:
