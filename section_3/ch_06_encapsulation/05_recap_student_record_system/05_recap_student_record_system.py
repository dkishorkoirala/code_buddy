...
In this challenge, you'll implement a complete student records management system.

You need to edit two files to complete this challenge:

student.py - Implement the Student class with proper encapsulation
studentregistry.py - Implement the StudentRegistry class to manage students
